...
Plan #105 V2 prepares staged Admin, New identity, and Retirement capabilities
without reopening raw settings or weakening database enforcement. Published
rows remain immutable and published identities are never hard-deleted.
Retirement stays false until P-19 PDF behavior is implemented and verified. See
