...
permanent derived state. P-38 remains paused until the complete P-39R gates
pass.
...
local-only Phase 4 scripts `017` through `024`, and runs the bootstrap smoke
