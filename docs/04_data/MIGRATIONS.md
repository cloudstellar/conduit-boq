...
repository/static gates. P-35 is repository integration only: P-36 still
requires a fresh destructive-reset warning and explicit owner approval before
the first integrated execution.
