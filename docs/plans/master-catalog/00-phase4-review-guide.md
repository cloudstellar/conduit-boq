...
| P-18 placement governance สำหรับ add/supplement | P-30 รับรองกติกา V1, amended WP-7.5 ผ่าน P-32 Local DB/browser/export evidence และ P-33 รับรองขอบเขตเทคนิคแล้วตาม [Review Note #28](./28-phase4-p18-placement-governance-review-note.md). P-34 exact `0780925` ผ่าน WP-8 source/static ด้าน dirty state, recoverable choices, review-by-exception, keyboard และ complete impact แล้ว แต่ Add/Supplement ต้องซ่อน/ปิดต่อจนผ่าน integrated Local performance/accessibility/recovery และ independent intended-admin UAT |
