...
| P-18 placement governance สำหรับ add/supplement | P-30 รับรองกติกา V1 แล้ว และ amended WP-7.5 ผ่าน P-32 Local DB/browser/export evidence ตาม [Review Note #28](./28-phase4-p18-placement-governance-review-note.md). ยังต้องตัดสิน P-33; Add/Supplement ต้องซ่อน/ปิดต่อจนผ่าน WP-8/P-14 |
