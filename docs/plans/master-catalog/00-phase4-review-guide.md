...
| P-18 placement governance สำหรับ add/supplement | P-30 รับรองกติกา V1, amended WP-7.5 ผ่าน P-32 Local DB/browser/export evidence และ P-33 รับรองขอบเขตเทคนิคแล้วตาม [Review Note #28](./28-phase4-p18-placement-governance-review-note.md). P-36 integrated Local technical rehearsal ผ่าน; corrected P-37 flow ผ่าน leave/return/reload recovery และ gap-list `ArrowDown`/`Enter` ที่ checkpoint `96c2ac6892e8ffe9d020c2dff641a847157cd4b2` แต่ Add/Supplement ต้องซ่อน/ปิดต่อจน complete native-button keyboard UAT และ explicit owner acceptance ผ่าน |
