...
| One working draft + stale/abandoned history | One mutable draft per base; duplicate/concurrent create denied; audited abandon/replacement; stale/abandoned views read-only | Prior G1R/G2/G3 path and P-36 integrated lifecycle/cleanup passed; realistic fixture was audited-abandoned and zero working drafts remained | Passed technical rerun; independent core-admin use remains C-09 |
