...
without reset. Full working-tree verification passed 34 files/220 tests,
TypeScript, lint 0 errors/10 existing warnings, authority/input checks, script
syntax, network-enabled build, and diff checks. Exact commit/push, clean
`017`-`025` execution, live smoke, and fresh scored Cards A-G remain pending.
...
| P-41 category/preview/withdraw-order correction | Authority-key bounds, read-only preview semantics, gap rejection, post-withdraw compaction, and one-revision transaction semantics agree across app, migration, bootstrap, smoke, tests, and authority docs | Migration `025` SHA-256 `00d79d7750aa52ba7f003f6bb82fedb1d31ab111be417d74329c1cd3d899f76f`; incremental Local apply; full working-tree 34 files/220 tests, TypeScript, lint 0 errors/10 existing warnings, authority/input/syntax/build/diff checks passed | Source verified; exact pushed checkpoint, live smoke, clean `017`-`025`, and fresh scored Cards A-G pending |
