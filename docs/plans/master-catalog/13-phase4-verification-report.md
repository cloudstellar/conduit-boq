...
Final readback repeated pointer `2568.0.0`/710, the exact canonical hash, zero
working drafts, all flags false, BOQ 198/1,547, and Factor F `2569.0.0`/36.
A separately approved clean `017`-`025` execution and fresh scored Cards A-G
remain pending.
...
| P-41 P-38 discovery correction | Owner + Codex | Exact source and incremental live smoke passed; acceptance and scored P-37 evidence not inferred | 2026-07-19 | UAT-06 found the 64-character `categoryCode` ceiling below the real 89-character authority key; UAT-07 found retirement-disabled Full preview incorrectly coupled to persistence; UAT-08 found base-absent withdrawal left a hidden `display_order` gap that the client masked and the DB rejected. The app now uses a 500-character bounded contract plus live dictionary preflight, exposes a complete read-only/no-Apply preview, rejects gapped placement input, and appends migration `025` SHA-256 `00d79d7750aa52ba7f003f6bb82fedb1d31ab111be417d74329c1cd3d899f76f` for atomic compaction. Discovery drafts were abandoned, flags/readback restored, and `025` applied incrementally without reset. Exact pushed `bb27b0d28e116e97ce1e7ee3e582f39bcc4edf22` passed 34 files/220 tests, TypeScript, lint 0 errors/10 existing warnings, authority/input/syntax/build/diff checks, and live WP-6.6 smoke; evidence SHA-256 `8d118e14c69f7ea9209123852011b1610d4c63687ff5133136bd6f15875463ed`. Post-smoke readback returned the exact disabled baseline. Clean `017`-`025` and fresh scored Cards A-G remain pending. Production touched: No. |
...
| P-41 category/preview/withdraw-order correction | Authority-key bounds, read-only preview semantics, gap rejection, post-withdraw compaction, and one-revision transaction semantics agree across app, migration, bootstrap, smoke, tests, and authority docs | Migration `025` SHA-256 `00d79d7750aa52ba7f003f6bb82fedb1d31ab111be417d74329c1cd3d899f76f`; incremental Local apply; exact pushed `bb27b0d28e116e97ce1e7ee3e582f39bcc4edf22`; 34 files/220 tests, TypeScript, lint 0 errors/10 existing warnings, authority/input/syntax/build/diff checks; live smoke evidence SHA-256 `8d118e14c69f7ea9209123852011b1610d4c63687ff5133136bd6f15875463ed`; post-smoke disabled-baseline readback | Exact source and incremental live smoke passed; clean `017`-`025` and fresh scored Cards A-G pending |
