...
Only the explicit P-37 owner accept/hold decision remains open. WP-8 is In
progress; P-37 remains HOLD and Production
...
| 4C clean rehearsal | Local | Codex + owner/developer | 2026-07-15 |  | P-36 integrated rehearsal and all P-37 technical/recovery/owner keyboard gates passed; WP-8 remains In progress and P-37 remains HOLD only for the explicit owner decision | Exact checkout `910cc3c` passed the integrated chain through `021`, DB/RLS/concurrency/P-20/WP-7/WP-7.5, export/advisors/repository gates, realistic scale, and disabled-baseline cleanup. Later no-reset continuations passed stale/replay/accepted-state/recovery plus complete owner `Tab`/`Shift+Tab`, `Enter`/`Space`, sibling-order, focus-return, and final-presentation review. Final source checkpoint `f36d896d672609653de6634e307dcc44bce6d519` is pushed; fixture `2568.15.0` was audited-abandoned and baseline invariants returned exact. |
...
| P-37 WP-8 accept/hold | Owner | HOLD retained only for the explicit owner accept/hold decision; all named technical, recovery, keyboard, focus, and presentation gates passed | 2026-07-17/18 | The insertion-gap correction preserves the DB contract. Complete owner keyboard/focus/presentation UAT passed without a placement submission on no-reset `2568.15.0`; final pushed checkpoint `f36d896d672609653de6634e307dcc44bce6d519` passed full verification and cleanup. Add/Supplement stays hidden until the explicit decision is recorded. See [P-37 UAT/UX Note](./33-phase4-wp8-p37-uat-ux-correction-note.md). |
...
names from DB-preview-derived final positions. Only explicit owner P-37
acceptance remains; Add/Supplement stays hidden until that decision.
...
|---|---|---|---|
| WP-8 clean Local rehearsal | Passed with no unresolved blocker | P-36 integrated technical rehearsal and final P-37 recovery/owner keyboard/focus/presentation UAT passed; `2568.15.0` cleanup returned the exact disabled baseline | Pending only explicit P-37 owner acceptance |
| WP-6.6 capability matrix | Audit #29 C-01 through C-17 implemented/evidenced, or unsupported controls removed from release visibility | Final G1R/G2/P-25/G3/P-26 path was owner-accepted at `78e96ab`; P-36 integrated rerun and final P-37 owner UAT passed | Accepted/Complete technically and for operator UAT; explicit P-37 package decision remains |
...
UAT and cleanup on `f36d896d672609653de6634e307dcc44bce6d519`. P-37 therefore
remains HOLD only for the explicit owner decision in
[Review Note #33](./33-phase4-wp8-p37-uat-ux-correction-note.md).
