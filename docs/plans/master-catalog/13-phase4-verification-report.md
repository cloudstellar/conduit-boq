...
| Documentation consistency | Authority links/table shapes, migration order, WP order, decisions, and execution provenance agree | Exact recovery evidence `1c901855...`, bounded source `bdc104f...`, C03/G01 correction `44f54a7...`, and modal correction `16e88c6...` are reflected across Verification, Decision Register, Tracker, Owner Script, and Closure Matrix. The current correction passed focused 1 file/15 tests, full 36 files/230 tests, TypeScript, lint with 0 errors/10 existing warnings, authority 710/65/17, input verification 708/708/693, network-enabled build, real Browser wheel/outside-dismiss checks, and diff check. | Passed for current checkpoint; update again after Spots 3-4 and final cleanup |
...
| P-41 category/preview/withdraw-order correction | Authority-key bounds, read-only preview semantics, gap rejection, post-withdraw compaction, and one-revision transaction semantics agree across app, migration, bootstrap, smoke, tests, and authority docs | Migration `025` SHA-256 `00d79d7750aa52ba7f003f6bb82fedb1d31ab111be417d74329c1cd3d899f76f`; exact source `bb27b0d28e116e97ce1e7ee3e582f39bcc4edf22`; clean execution `adcca3939f3080cdf64bc6ad807051e9e85fed94`; WP-6.5 `4b69e44dde915ca25c3f78379a1c45b002b31cb8aebcbf361ec3b58670f9e245`, WP-6.6 `e9e28eb1bb6f312a4638c0d67b00cb420864d5433295ffb80a95a12ee9e14251`, WP-7 `5b6a01837d2836a33a000489ff6dad4519ca40ca67e48464cc384b84721c8195`, WP-7.5 `0fd213f5ace8e077790d81a1c49b78a3fff3f1912a01aef5b52b7df6d1460240`; live category maximum 96 under contract 500; canonical `sha256:2e3571...`; final pointer `2568.0.0`/710, zero drafts, flags false, BOQ 198/1,547, Factor F `2569.0.0`/36 | Exact source, incremental smoke, clean `017`-`025`, and P-42 recovery preflight passed; Spots 1-2 are retained and only Spots 3-4 plus cleanup remain open |
| P-42 review snapshot/terminal-state correction and recovery | Draft review URL identity, stale hard stop, terminal read-only wording, preserved return context, DB-guard authority, incident evidence, recovery baseline, functional Cards A-G, compact-overview containment, and cleanup agree | Incident source `d00c941`; correction `b2500b5e...`; recovery source `f8c6709...`; bounded findings `bdc104f...`; Owner-accepted responsive correction `bcc0417...`; session `session-p42-scored-20260719-f8c6709.json`; inputs 708/708/693; authority 710/65/17; Card F request `35defa1c-...` exactly one effect; responsive checks at 1,443 px and 390 x 844; clean pointer `2568.0.0`/710, zero drafts, flags false; Notes #35/#36/#38 | Source correction, separately approved recovery, functional A-G, cleanup, P42-UAT-OV01, and Spots 1-2 passed; completed Card B-E evidence is retained and Spots 3-4 plus cleanup remain HOLD |
| P-42 proportional spot-check and placement-modal correction | Import progress wording, guarded persistence, E-01 observation, schema-2 bounded cleanup, and modal-contained gap scrolling agree without changing DB authority | Spot 1 passed on exact `fd36be2`; D004 Spot 2 passed with `IMPORT_PRICE_AUTHORITY_REQUIRED`, no persistence, and correct action visibility. D004 cleanup passed with one audited-abandoned attempt and restored pointer `2568.0.0`/710, zero drafts, flags false, BOQ 198/1,547, Factor F `2569.0.0`/36. Real Browser Spot 3 exposed the nested-popover wheel failure. Exact `16e88c6487307c4bb0606a048dc53e05e9dcee18` passed focused 1 file/15 tests, full 36 files/230 tests, TypeScript, lint 0 errors/10 warnings, authority 710/65/17, input verification 708/708/693, network-enabled build, Browser wheel/outside-dismiss checks, and diff check | Spots 1-2 and D004 cleanup passed; exact-source Spots 3-4 and final schema-2 cleanup remain HOLD |
