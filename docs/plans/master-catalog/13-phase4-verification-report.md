...
| P-42 final-review snapshot binding and incident correction | Owner + Codex | Exact source/docs checkpoint pushed after repository and published-state QA; interrupted scored Card A remains invalid and P-37 remains HOLD | 2026-07-19 | Exact prepared source `d00c941` issued Local `2568.5.0` through a current-lock request, then terminal review displayed false draft-only stale-base wording. No DB lock bypass or Production action. Exact pushed correction `b2500b5e6859a915bfa3f70d558934f252943f82` binds review URLs to `reviewLock`, hard-stops mismatch without publish controls, and makes terminal review read-only. Focused 3 files/26 tests, full 35 files/225 tests, TypeScript, lint 0 errors/10 existing warnings, authority 710/65/17, real-parser input verification 708/708/693, network-enabled build, diff check, and published-state browser/visual QA passed. Separately approved clean Local recovery remains pending. See Note #38. |
...
| P-42 review snapshot/terminal-state correction | Draft review URL identity, stale hard stop, terminal read-only wording, preserved return context, DB-guard authority, incident evidence, and safer Card A agree | Exact incident source `d00c941`; exact pushed correction `b2500b5e6859a915bfa3f70d558934f252943f82`; Local issued `2568.5.0`/710 hash `sha256:46b4b61a...`; focused 3 files/26 tests; full 35 files/225 tests; TypeScript; lint 0 errors/10 existing warnings; authority 710/65/17 SHA-256 `28675e6244c65d485dda7142634b381db729a139bccdf189ad51563251a2e12a`; real-parser input verification 708/708/693; network-enabled build; diff check; published-state browser/visual QA; Note #38 and aligned authority docs | Exact source/docs/browser checkpoint passed and pushed; separately approved clean recovery and fresh scored Card A remain |
