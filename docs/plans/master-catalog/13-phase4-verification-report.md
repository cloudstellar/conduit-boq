...
disabled-baseline readback was restored, but fresh scored Cards A-G remain
pending. Before P-39, the historical
...
versioned category keys may be full authority labels (Local maximum 89), a
...
SHA-256 `4b69e44d...`, `e9e28eb1...`, `5b6a0183...`, and `0fd213f5...`.
...
The P-42 source candidate binds mutable review routes to `reviewLock`, makes a
...
review with accurate read-only/base-versus-this-version wording. Focused 2
files/19 tests, full 35 files/225 tests, TypeScript, and published-route browser
QA pass at the working-tree checkpoint. Remaining repository/docs checks and
an exact commit/push precede a new owner decision. Because the issued Local
...
| P-41 P-38 discovery correction and clean chain | Owner + Codex | Exact source, incremental smoke, and clean integrated execution passed; scored P-37 evidence not inferred | 2026-07-19 | UAT-06 found the 64-character `categoryCode` ceiling below the real 89-character authority key; UAT-07 found retirement-disabled Full preview incorrectly coupled to persistence; UAT-08 found base-absent withdrawal left a hidden `display_order` gap that the client masked and the DB rejected. The app uses a 500-character bounded contract plus live dictionary preflight, exposes a complete read-only/no-Apply preview, rejects gapped placement input, and appends migration `025` SHA-256 `00d79d7750aa52ba7f003f6bb82fedb1d31ab111be417d74329c1cd3d899f76f`. Exact source `bb27b0d28e116e97ce1e7ee3e582f39bcc4edf22` passed source and incremental smoke gates. After a fresh reset warning/approval, exact pushed `adcca3939f3080cdf64bc6ad807051e9e85fed94` clean-applied `009`-`015`, hotfix `016`, `017`-`025`; WP-6.5/WP-6.6/WP-7/WP-7.5 evidence SHA-256 `4b69e44dde915ca25c3f78379a1c45b002b31cb8aebcbf361ec3b58670f9e245`, `e9e28eb1bb6f312a4638c0d67b00cb420864d5433295ffb80a95a12ee9e14251`, `5b6a01837d2836a33a000489ff6dad4519ca40ca67e48464cc384b84721c8195`, and `0fd213f5ace8e077790d81a1c49b78a3fff3f1912a01aef5b52b7df6d1460240`; canonical/final disabled-baseline readback passed. Fresh scored Cards A-G remain pending. Production touched: No. |
| P-42 final-review snapshot binding and incident correction | Owner + Codex | Interrupted scored Card A preserved; bounded working-tree source/docs correction passed repository and published-state QA; P-37 remains HOLD | 2026-07-19 | Exact prepared source `d00c941` issued Local `2568.5.0` through a current-lock request, then terminal review displayed false draft-only stale-base wording. No DB lock bypass or Production action. The correction binds review URLs to `reviewLock`, hard-stops mismatch without publish controls, and makes terminal review read-only. Focused 3 files/26 tests, full 35 files/225 tests, TypeScript, lint 0 errors/10 existing warnings, authority 710/65/17, real-parser input verification 708/708/693, network-enabled build, diff check, and published-state browser/visual QA passed. Exact commit/push and separately approved clean Local recovery remain pending. See Note #38. |
...
| Documentation consistency | Authority links/table shapes, migration order, WP order, decisions, and execution provenance agree | Note #34 removes the overbroad only-owner-decision conclusion and updates executable assertions. Focused authority/operator checks passed 2 files/21 tests; the full suite passed 33 files/184 tests; TypeScript, lint with 0 errors/10 existing warnings, authority 710/65/17 SHA-256 `28675e6244c65d485dda7142634b381db729a139bccdf189ad51563251a2e12a`, and diff check passed. | Passed; C-12 closed |
...
| P-40 exploratory-UAT correction | UI normalization, unit governance, withdrawal recovery, actual-parser Excel compatibility, and UAT ordering agree without changing DB behavior | Exact pushed `dc83c35`; real-parser pinned inputs 708/708/693; 34 files/216 tests; TypeScript; lint 0 errors/10 existing warnings; network-enabled build; diff check; separate no-reset developer browser QA and disabled-baseline readback; no migration/reset/Production/Factor F/hotfix change | Passed source/docs and separate developer browser QA; fresh scored Cards A-G pending |
| P-41 category/preview/withdraw-order correction | Authority-key bounds, read-only preview semantics, gap rejection, post-withdraw compaction, and one-revision transaction semantics agree across app, migration, bootstrap, smoke, tests, and authority docs | Migration `025` SHA-256 `00d79d7750aa52ba7f003f6bb82fedb1d31ab111be417d74329c1cd3d899f76f`; exact source `bb27b0d28e116e97ce1e7ee3e582f39bcc4edf22`; clean execution `adcca3939f3080cdf64bc6ad807051e9e85fed94`; WP-6.5 `4b69e44d...`, WP-6.6 `e9e28eb1...`, WP-7 `5b6a0183...`, WP-7.5 `0fd213f5...`; canonical `sha256:2e3571...`; final pointer `2568.0.0`/710, zero drafts, flags false, BOQ 198/1,547, Factor F `2569.0.0`/36 | Exact source, incremental smoke, and clean `017`-`025` passed; fresh scored Cards A-G pending |
| P-42 review snapshot/terminal-state correction | Draft review URL identity, stale hard stop, terminal read-only wording, preserved return context, DB-guard authority, incident evidence, and safer Card A agree | Exact incident source `d00c941`; Local issued `2568.5.0`/710 hash `sha256:46b4b61a...`; focused 3 files/26 tests; full 35 files/225 tests; TypeScript; lint 0 errors/10 existing warnings; authority 710/65/17 SHA-256 `28675e6244c65d485dda7142634b381db729a139bccdf189ad51563251a2e12a`; real-parser input verification 708/708/693; network-enabled build; diff check; published-state browser/visual QA; Note #38 and aligned authority docs | Working-tree source/docs/browser verification passed; exact commit/push, separately approved clean recovery, and fresh scored Card A remain |
