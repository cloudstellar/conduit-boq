...
later WP-8 owner accept/hold decision.
...
| P-35 WP-8 bootstrap source integration | Repository/source integration authorized; destructive execution held | Owner + developer | 2026-07-15 | Add unchanged amended `021` after `020`, align current authority and executable contracts, verify, commit, and push. P-36 reset/live evidence, P-37 acceptance, feature enablement, publication, and Production remain separate. |
| P-36 WP-8 destructive Local execution | Not requested | Owner + developer |  | Requires a fresh explicit warning that bootstrap resets all Local Supabase and approval against the exact pushed P-35 checkpoint. |
