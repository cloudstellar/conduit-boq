...
| Deploy / feature enable | P-13 PRE-DEPLOY PREPARATION IN PROGRESS; P-14 not requested | Owner | After P-12 closeout | P-13 remains blocked on the exact deployment commit/remote CI/fingerprint and a separate deploy window. P-14 remains blocked until P-13 smoke passes and its separate Auth/feature decision is recorded. |
