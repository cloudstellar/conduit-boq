...
| WP-6.6 P-24 pre-G1R hardening | Bounded base implementation passed on `88d0711`; same-scope repeated-error-focus/provenance closure committed on `050c998`; no reset approved | Owner | 2026-07-13 | Annual range, stable error, durable identical-retry focus, contextual authority, Factor F hierarchy, and exact execution-provenance contract; G1R remains a separate decision and runtime evidence gate |
