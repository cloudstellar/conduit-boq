...
| WP-6.6 operator workflow correction | G0 authorized; source/static implementation passed on `ac31feb` | Owner | 2026-07-12 | P-22; G1/G2 resets, G3 closeout, G4 bootstrap/WP-7, and all Production actions remain separate |
