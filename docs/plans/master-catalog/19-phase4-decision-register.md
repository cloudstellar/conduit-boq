...
reset or migration `020` change. G2, G3, G4, and every Production action remain
separate decisions.
...
| WP-6.6 operator workflow correction | G0 authorized; G1 Local evidence passed on `e463270`; pre-G2 technical operator checkpoint passed on `c8f6dca` | Owner | 2026-07-12 | P-22; G2 exact-`c8f6dca` clean rebuild/comparison, G3 closeout, G4 bootstrap/WP-7, and all Production actions remain separate |
