...
WP-6 remains `Ready for owner review` until the owner gives the short final
visual/content confirmation of those named binaries.
...
| Official export format | TH Sarabun New 16 pt replacement pair passed technically; owner acceptance pending | Owner | 2026-07-11 | P-11; exact replacement DB-generated Excel/PDF passed count/hash, typography, and visual QA; final owner/file acceptance remains separate |
