...
| WP-6.6 P-24 pre-G1R hardening | Bounded implementation and repository/static gate passed; no reset approved | Owner | 2026-07-13 | Annual range, stable error, durable focus, contextual authority, and Factor F hierarchy patch; exact implementation commit precedes G1R |
