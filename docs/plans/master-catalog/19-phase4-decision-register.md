...
| Production migration | HOLD; P-12 not requested |  |  | Package #39 is prepared; request only after fresh Production read-only, backup/restore, advisor, executor, and exact-window evidence is green |
