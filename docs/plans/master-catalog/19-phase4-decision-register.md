...
refresh. The post-reload stale-choice-discard banner was not separately
captured before cleanup; retained Card D and automated lock/revision contracts
cover the underlying fail-closed behavior. P-37 remains HOLD only for the
explicit Owner decision to accept that bounded observation or request one
narrow no-reset visual replay. “ทำต่อ” is not recorded as acceptance, and no
...
| P-37 | Accept or hold WP-8 and the Production-readiness package | Review exact P-36 execution provenance, clean final invariants, realistic-scale evidence, intended-admin UAT without developer/SQL assistance, advisor disposition, tracked export verification, and authority consistency. Acceptance permits only a later P-12 request; it does not authorize Production migration, deploy, enablement, or publication. | Owner | After every WP-8 exit gate passes | **HOLD only for explicit Owner accept/hold:** final exact-source D005 completed the bounded placement and same-request checks and restored the disabled baseline. The post-reload stale-choice-discard banner was not separately captured; retained Card D and automated lock/revision contracts cover the underlying fail-closed behavior. The Owner may accept this managed observation or request one narrow no-reset visual replay. See [Closure Matrix #34](./34-phase4-wp8-p37-closure-matrix.md) and [Review Note #33](./33-phase4-wp8-p37-uat-ux-correction-note.md). |
| P-38 | Authorize evidence reconciliation and the bounded no-reset Local Owner UAT needed to resolve P-37 | Use [Owner UAT Script #35](./35-phase4-wp8-p37-evidence-reconciliation-and-owner-uat-script.md) and [Preflight Note #36](./36-phase4-wp8-p38-no-reset-owner-uat-preflight.md): preserve actor-independent evidence; prepare only reproducible untracked Local test inputs/faults; have the intended admin complete Cards A-G without live developer/SQL help; audit cleanup and exact disabled-baseline readback; verify, commit, and push before requesting P-37. Do not reset Local, publish successfully, infer P-37, enable Production features, decide P-19, touch Production, reopen Factor F, or expand hotfix `016`. | Owner + developer | After Closure Matrix #34 reconciliation and before the final P-37 accept/hold request | First Card A was stopped and safely cleaned after the official-number-gap finding. P-42 later retained completed Card B-E evidence and narrowed current closure to four post-correction Owner spot-checks plus cleanup at that checkpoint. Subsequent proportional exact-source execution and final cleanup are complete. D005 passed Spot-check 3 and the same-request portion of Spot-check 4; cleanup restored pointer `2568.0.0`/710, zero drafts, and all flags false. Only the explicit P-37 Owner disposition remains, with one optional narrow banner replay. |
...
| P-37 WP-8 owner acceptance | HOLD only for explicit Owner accept/hold after bounded execution and cleanup | Owner | 2026-07-17/18; execution completed 2026-07-23 | D005 completed the exact-source placement and same-request checks and restored the disabled baseline. The one uncaptured stale-choice-discard banner is explicitly bounded for Owner acceptance or one narrow no-reset replay. Add/Supplement stays hidden. |
| P-38 bounded Owner UAT | Evidence reconciliation, proportional execution, and cleanup complete; P-37 decision pending | Owner + developer | 2026-07-18 through 2026-07-23 | Retained functional Cards B-E plus Spots 1-3 and same-request Spot 4 satisfy the bounded execution; D005 cleanup restored pointer `2568.0.0`/710, zero drafts, and flags false without reset. |
...
| P-42 final-review correction and recovery | Exact corrections, recovery, retained functional cards, proportional exact-source execution, and cleanup passed; P-37 Owner decision remains | Owner + developer | 2026-07-19 through 2026-07-23 | Final-review `b2500b5e...`; recovery `f8c6709...`; evidence `1c901855...`; bounded findings `bdc104f...`; modal correction `16e88c6...`; D005 source `6fe3a6a...`; durable success `b639c03`. Final Local is pointer `2568.0.0`/710, zero drafts, all flags false, and unchanged BOQ/Factor F invariants. No full replay, further reset, or Production action is authorized. |
...
| P-42 final exact-source spot-check and cleanup | Execution passed; P-37 Owner decision pending | Owner + developer | 2026-07-23 | Exact D005 source/session passed Spot 3 and same-request Spot 4; cleanup restored the disabled baseline without reset; `b639c03` keeps recovered success visible. The stale-choice banner remains one bounded observation and is not falsely marked passed. Production untouched. |
